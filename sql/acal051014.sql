...
CREATE TABLE `conta` (
  ...
  `observacoes` text,
  `SocioExclusivo` bit(1) NOT NULL,
  `ValorOutros` decimal(19,2) DEFAULT NULL,
  `ValorTaxa` decimal(19,2) DEFAULT NULL,
...
--
-- Table structure for table `endereco_view`
--
...
--
-- Dumping data for table `endereco_view`
--

LOCK TABLES `endereco_view` WRITE;
/*!40000 ALTER TABLE `endereco_view` DISABLE KEYS */;
/*!40000 ALTER TABLE `endereco_view` ENABLE KEYS */;
UNLOCK TABLES;
...
CREATE TABLE `enderecopessoa` (
  ...
  PRIMARY KEY (`id`),
  KEY `FK80ECBCB09D0D13A6` (`idCategoriaSocio`),
  ...
  CONSTRAINT `FK80ECBCB09D0D13A6` FOREIGN KEY (`idCategoriaSocio`) REFERENCES `categoriasocio` (`id`),
...
--
-- Table structure for table `geracaocontas`
--

DROP TABLE IF EXISTS `geracaocontas`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `geracaocontas` (
  `id` int(11) NOT NULL,
  ...
  `SocioExclusivo` bit(1) DEFAULT NULL,
  `valor` decimal(19,2) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Dumping data for table `geracaocontas`
--

LOCK TABLES `geracaocontas` WRITE;
/*!40000 ALTER TABLE `geracaocontas` DISABLE KEYS */;
/*!40000 ALTER TABLE `geracaocontas` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `rc_caixa`
--

DROP TABLE IF EXISTS `rc_caixa`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `rc_caixa` (
...
--
-- Dumping data for table `rc_caixa`
--

LOCK TABLES `rc_caixa` WRITE;
/*!40000 ALTER TABLE `rc_caixa` DISABLE KEYS */;
/*!40000 ALTER TABLE `rc_caixa` ENABLE KEYS */;
UNLOCK TABLES;
...
--
-- Table structure for table `socios_view`
--

DROP TABLE IF EXISTS `socios_view`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!40101 SET character_set_client = utf8 */;
CREATE TABLE `socios_view` (
  `id` int(11) NOT NULL,
  `nome` varchar(255) DEFAULT NULL,
  `SocioExclusivo` bit(1) DEFAULT NULL,
  PRIMARY KEY (`id`)
...
--
-- Dumping data for table `socios_view`
--

LOCK TABLES `socios_view` WRITE;
/*!40000 ALTER TABLE `socios_view` DISABLE KEYS */;
/*!40000 ALTER TABLE `socios_view` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2014-10-05  9:28:23
